...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || process.env.IMAGE || "https://telegra.ph/file/00c3701c235a6df1dba76.png";
global.devs = "2348140825959";
...
module.exports = {
  ...
  ownername: process.env.OWNER_NAME || "BAD BOI",
  ...
  LANG: (process.env.THEME || "H A C K E R").toUpperCase(),
};
global.rank = "updated";
